package com.example.lavajavaapp.CustomerFoodPanel;
...
public class PayableOrderAdapter extends RecyclerView.Adapter<PayableOrderAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.Price.setText("Price: RS. " + customerPaymentOrders.getDishPrice());
        holder.Quantity.setText("× " + customerPaymentOrders.getDishQuantity());
        holder.Totalprice.setText("Total: RS. " + customerPaymentOrders.getTotalPrice());
    }
